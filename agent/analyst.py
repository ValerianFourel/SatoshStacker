...
_SYSTEM = (
    ...
    "• `multi_timeframe` — per 5m/15m/1h/4h/1d: RSI, EMA-trend, price distance from EMA50/EMA200 "
    "(`ema50_dist_pct`/`ema200_dist_pct`) and EMA50 velocity (`ema50_vel_pct`); use the timeframe "
    "matching the horizon being asked about.\n"
